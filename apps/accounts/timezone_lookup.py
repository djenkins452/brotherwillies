# US zip code prefix (first 3 digits) to timezone mapping.
# Covers all US zip code ranges including territories.

_ZIP3_TO_TZ = {
    # Connecticut, Massachusetts, Maine, New Hampshire, New Jersey, Puerto Rico,
    # Rhode Island, Vermont, Virgin Islands, APO/FPO
    '006': 'America/Puerto_Rico', '007': 'America/Puerto_Rico', '008': 'America/Puerto_Rico',
    ...
    # New Jersey
    '070': 'America/New_York', '071': 'America/New_York', '072': 'America/New_York',
    '073': 'America/New_York', '074': 'America/New_York', '075': 'America/New_York',
    '076': 'America/New_York', '077': 'America/New_York', '078': 'America/New_York',
    '079': 'America/New_York', '080': 'America/New_York', '081': 'America/New_York',
    '082': 'America/New_York', '083': 'America/New_York', '084': 'America/New_York',
    '085': 'America/New_York', '086': 'America/New_York', '087': 'America/New_York',
    '088': 'America/New_York', '089': 'America/New_York',
    # APO/FPO
    '090': 'America/New_York', '091': 'America/New_York', '092': 'America/New_York',
    '093': 'America/New_York', '094': 'America/New_York', '095': 'America/New_York',
    '096': 'America/New_York', '097': 'America/New_York', '098': 'America/New_York',
    '099': 'America/New_York',
    # New York
    ...
    '120': 'America/New_York', '121': 'America/New_York', '122': 'America/New_York',
    '123': 'America/New_York', '124': 'America/New_York', '125': 'America/New_York',
    '126': 'America/New_York', '127': 'America/New_York', '128': 'America/New_York',
    '129': 'America/New_York', '130': 'America/New_York', '131': 'America/New_York',
    '132': 'America/New_York', '133': 'America/New_York', '134': 'America/New_York',
    '135': 'America/New_York', '136': 'America/New_York', '137': 'America/New_York',
    '138': 'America/New_York', '139': 'America/New_York', '140': 'America/New_York',
    '141': 'America/New_York', '142': 'America/New_York', '143': 'America/New_York',
    '144': 'America/New_York', '145': 'America/New_York', '146': 'America/New_York',
    '147': 'America/New_York', '148': 'America/New_York', '149': 'America/New_York',
    # Pennsylvania
    ...
    '170': 'America/New_York', '171': 'America/New_York', '172': 'America/New_York',
    '173': 'America/New_York', '174': 'America/New_York', '175': 'America/New_York',
    '176': 'America/New_York', '177': 'America/New_York', '178': 'America/New_York',
    '179': 'America/New_York', '180': 'America/New_York', '181': 'America/New_York',
    '182': 'America/New_York', '183': 'America/New_York', '184': 'America/New_York',
    '185': 'America/New_York', '186': 'America/New_York', '187': 'America/New_York',
    '188': 'America/New_York', '189': 'America/New_York', '190': 'America/New_York',
    '191': 'America/New_York', '192': 'America/New_York', '193': 'America/New_York',
    ...
    '212': 'America/New_York', '213': 'America/New_York', '214': 'America/New_York',
    '215': 'America/New_York', '216': 'America/New_York', '217': 'America/New_York',
    ...
    '246': 'America/New_York', '247': 'America/New_York', '248': 'America/New_York',
    '249': 'America/New_York', '250': 'America/New_York', '251': 'America/New_York',
    '252': 'America/New_York', '253': 'America/New_York', '254': 'America/New_York',
    '255': 'America/New_York', '256': 'America/New_York', '257': 'America/New_York',
    '258': 'America/New_York', '259': 'America/New_York', '260': 'America/New_York',
    '261': 'America/New_York', '262': 'America/New_York', '263': 'America/New_York',
    '264': 'America/New_York', '265': 'America/New_York', '266': 'America/New_York',
    '267': 'America/New_York', '268': 'America/New_York',
    # North Carolina
    ...
    '323': 'America/New_York', '324': 'America/New_York',
    '325': 'America/Chicago',  # Panama City area
    '326': 'America/New_York',
    '336': 'America/New_York', '337': 'America/New_York', '338': 'America/New_York',
    '339': 'America/New_York', '340': 'America/New_York', '341': 'America/New_York',
    ...
    '353': 'America/Chicago', '354': 'America/Chicago', '355': 'America/Chicago',
    '356': 'America/Chicago', '357': 'America/Chicago', '358': 'America/Chicago',
    '359': 'America/Chicago', '360': 'America/Chicago', '361': 'America/Chicago',
    ...
    '415': 'America/New_York', '416': 'America/New_York', '417': 'America/New_York',
    '418': 'America/New_York',
    # Western KY (Central)
    '420': 'America/Chicago', '421': 'America/Chicago', '422': 'America/Chicago',
    '423': 'America/Chicago', '424': 'America/Chicago', '425': 'America/Chicago',
    ...
    '457': 'America/New_York', '458': 'America/New_York',
    # Indiana
    '460': 'America/New_York', '461': 'America/New_York', '462': 'America/New_York',
    '463': 'America/New_York', '464': 'America/New_York', '465': 'America/New_York',
    '466': 'America/New_York', '467': 'America/New_York', '468': 'America/New_York',
    '469': 'America/New_York',
    # NW Indiana (Central)
    '463': 'America/New_York', '464': 'America/New_York',
    '470': 'America/New_York', '471': 'America/New_York', '472': 'America/New_York',
    '473': 'America/Chicago', '474': 'America/New_York', '475': 'America/New_York',
    '476': 'America/New_York', '477': 'America/Chicago', '478': 'America/New_York',
    '479': 'America/Chicago',
    # Michigan
    '480': 'America/New_York', '481': 'America/New_York', '482': 'America/New_York',
    '483': 'America/New_York', '484': 'America/New_York', '485': 'America/New_York',
    ...
    '515': 'America/Chicago', '516': 'America/Chicago',
    # Wisconsin
    ...
    # DC (already covered above), South Dakota
    ...
    '586': 'America/Chicago', '587': 'America/Chicago', '588': 'America/Chicago',
    # Montana
    ...
    '770': 'America/Chicago', '771': 'America/Chicago', '772': 'America/Chicago',
    '773': 'America/Chicago', '774': 'America/Chicago', '775': 'America/Chicago',
    '776': 'America/Chicago', '777': 'America/Chicago', '778': 'America/Chicago',
    '779': 'America/Chicago', '780': 'America/Chicago', '781': 'America/Chicago',
    '782': 'America/Chicago', '783': 'America/Chicago', '784': 'America/Chicago',
    '785': 'America/Chicago', '786': 'America/Chicago', '787': 'America/Chicago',
    '788': 'America/Chicago', '789': 'America/Chicago',
    # West Texas (some Mountain)
    '790': 'America/Chicago', '791': 'America/Chicago', '792': 'America/Chicago',
    '793': 'America/Chicago', '794': 'America/Chicago', '795': 'America/Chicago',
    '796': 'America/Chicago', '797': 'America/Chicago',
    # El Paso area (Mountain)
    ...
    # Idaho
    '832': 'America/Boise', '833': 'America/Boise', '834': 'America/Boise',
    '835': 'America/Boise', '836': 'America/Boise', '837': 'America/Boise',
    '838': 'America/Boise',
    # Utah
    ...
    '860': 'America/Phoenix', '863': 'America/Phoenix', '864': 'America/Phoenix',
    '865': 'America/Phoenix',
    # New Mexico
    ...
    # Nevada
    '889': 'America/Los_Angeles', '890': 'America/Los_Angeles',
    '891': 'America/Los_Angeles', '893': 'America/Los_Angeles',
    '894': 'America/Los_Angeles', '895': 'America/Los_Angeles',
    ...
    '908': 'America/Los_Angeles', '910': 'America/Los_Angeles',
    '911': 'America/Los_Angeles', '912': 'America/Los_Angeles',
    '913': 'America/Los_Angeles', '914': 'America/Los_Angeles',
    '915': 'America/Los_Angeles', '916': 'America/Los_Angeles',
    '917': 'America/Los_Angeles', '918': 'America/Los_Angeles',
    '919': 'America/Los_Angeles', '920': 'America/Los_Angeles',
    '921': 'America/Los_Angeles', '922': 'America/Los_Angeles',
    '923': 'America/Los_Angeles', '924': 'America/Los_Angeles',
    '925': 'America/Los_Angeles', '926': 'America/Los_Angeles',
    '927': 'America/Los_Angeles', '928': 'America/Los_Angeles',
    '930': 'America/Los_Angeles', '931': 'America/Los_Angeles',
    '932': 'America/Los_Angeles', '933': 'America/Los_Angeles',
    '934': 'America/Los_Angeles', '935': 'America/Los_Angeles',
    '936': 'America/Los_Angeles', '937': 'America/Los_Angeles',
    '938': 'America/Los_Angeles', '939': 'America/Los_Angeles',
    '940': 'America/Los_Angeles', '941': 'America/Los_Angeles',
    '942': 'America/Los_Angeles', '943': 'America/Los_Angeles',
    '944': 'America/Los_Angeles', '945': 'America/Los_Angeles',
    '946': 'America/Los_Angeles', '947': 'America/Los_Angeles',
    '948': 'America/Los_Angeles', '949': 'America/Los_Angeles',
    '950': 'America/Los_Angeles', '951': 'America/Los_Angeles',
    '952': 'America/Los_Angeles', '953': 'America/Los_Angeles',
    '954': 'America/Los_Angeles', '955': 'America/Los_Angeles',
    '956': 'America/Los_Angeles', '957': 'America/Los_Angeles',
    '958': 'America/Los_Angeles', '959': 'America/Los_Angeles',
    ...
    '978': 'America/Boise',  # Eastern Oregon
    '979': 'America/Boise',
    # Washington
    ...
    '997': 'America/Anchorage', '998': 'America/Anchorage',
    ...
    # Vermont
    '050': 'America/New_York', '051': 'America/New_York', '052': 'America/New_York',
    '053': 'America/New_York', '054': 'America/New_York', '056': 'America/New_York',
    '057': 'America/New_York', '058': 'America/New_York', '059': 'America/New_York',
    # Virgin Islands
    '008': 'America/Virgin',
    # Virginia (extra entries)
    '003': 'America/New_York', '004': 'America/New_York', '005': 'America/New_York',
}
